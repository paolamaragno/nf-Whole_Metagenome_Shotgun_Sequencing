...
process METAPHLAN4 {
	...
	script:
	"""
	metaphlan ${processed_fastq} --input_type fastq  --db_dir ${metaphlan_db}  --mapout ${sample_id}.bowtie2.bz2 --samout ${sample_id}.sam.bz2 -o ${sample_id}_profile.txt --nproc ${task.cpus} --read_min_len 100 -x ${params.metaphlan_db_index}
