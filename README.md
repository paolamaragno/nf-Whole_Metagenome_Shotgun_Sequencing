...
nextflow run main.nf --help
	...
	--metaphlan_db_vJun23		Path to the folder containing Metaphlan database vJun23 (default: false, in this case the 
								database will be downloaded by the pipeline)
	--metaphlan_db_vJan25		Path to the folder containing Metaphlan database vJan25 (default: false, in this case the database will be
								downloaded by the pipeline, if needed). 
